...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 0 0px;">
    <div style="flex: 1; margin-right: 50px; text-align: center;">
    ...
    <div style="flex: 1; margin-left: 50px; text-align: center;">
