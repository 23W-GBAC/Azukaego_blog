...
<div style="display: flex; flex-direction: row;">
    <div style="flex: 1; margin-right: 15px; text-align: center;">
        <a href="blog_post_one">
          ...
          <p style="position: absolute; bottom: 0; left: 0; width: 100%; text-align: center; background-color: rgba(255, 255, 255, 0.8); padding: 8px; box-sizing: border-box;">
            <strong style="margin: 0;">Mary's Diagnosis: A Journey <br>Through Medical Bias.</strong>
        </p>
    </div>
